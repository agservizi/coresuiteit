...
if (!function_exists('getClientEmailById')) {
 ...
 * @return bool
 */
if (!function_exists('creaNotifica')) {
...
if (!function_exists('getNotificheNonLette')) {
    /**
 ...
 * @return bool
 */
if (!function_exists('marcaNotificaLetta')) {
...
if (!function_exists('generaTokenRecupero')) {
    /**
...
if (!function_exists('verificaTokenRecupero')) {
    /**
 ...
 * @return bool
 */
if (!function_exists('registraDocumento')) {
